...
<table>
  <tr>
    <td>
      <p> Kyunghee University Student / Software Convergence</p> 
    </td>
  </tr>
</table>

### Projects
- 내리세요 (블루투스 비콘 기반 지하철 하차 알림 앱, Personal)
- 무진장 (무신사 옷 색상 기반 코디 추천 프로젝트, KHUDA 3rd)
- 리뷰 기반 카페 추천 앱, KHUDA 3rd
- Moods (공부 공간 & 시간 추천 앱, 2025 예술적인소프트웨어)
- InForest (웹 페이지 정리 & 메모용 데스크탑 앱, Personal)
- Jandi (플랫폼 통합 블로그 잔디밭 및 주제분류 서비스, GDGoC(KHU) 25-2 스터디 연합 프로젝트)
...
### Email & Blog
  ...
  <a href="https://jungdaegyun.notion.site/0bc6892cf1e744b182f6bd1bf8291899?source=copy_link"><img src="https://img.shields.io/badge/Blog-181717?style=flat-square&logo=notion&logoColor=white"/></a>
